...
<body>
  ...
  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
      <img src="./img/drapeau-france.jpg" height="200px" class="nav-link active" id="pills-france-tab"
        data-bs-toggle="pill" data-bs-target="#pills-france" type="button" role="tab" aria-controls="pills-france"
        aria-selected="true">
    </li>
    <li class="nav-item" role="presentation">
      <img src="./img/drapeau-etats-unis.jpg" height="200px" class=" nav-link" id="pills-usa-tab" data-bs-toggle="pill"
        data-bs-target="#pills-usa" type="button" role="tab" aria-controls="pills-usa" aria-selected="false">
    </li>
    <li class="nav-item" role="presentation">
      <img src="./img/drapeau-bresil.png" height="200px" class="nav-link" id="pills-bresil-tab" data-bs-toggle="pill"
        data-bs-target="#pills-bresil" type="button" role="tab" aria-controls="pills-bresil" aria-selected="false">
    </li>
    <li class="nav-item" role="presentation">
      <img src="./img/drapeau-dubai.png" height="140px" class="nav-link" id="pills-dubai-tab" data-bs-toggle="pill"
        data-bs-target="#pills-dubai" type="button" role="tab" aria-controls="pills-dubai" aria-selected="false">
    </li>
  </ul>
