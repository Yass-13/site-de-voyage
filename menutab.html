    ...
    <div class="h">
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-france" role="tabpanel" aria-labelledby="pills-france-tab">
            ...
            <div class="offre"><p>New york </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Miami </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Sao Paolo </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Rio </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Dubai </p><button>VOIR DETAILS</button></div>
        </div>
        <div class="tab-pane fade" id="pills-usa" role="tabpanel" aria-labelledby="pills-usa-tab">
            <p>Choissisez votre destination de rêve:</p>
            <div class="offre"><p>Marseille </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Paris </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Sao Paolo </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Rio </p><button>VOIR DETAILS</button></div>
            <div class="offre"><p>Dubai </p><button>VOIR DETAILS</button></div>
        </div>
